...
c1 = Category.create(name:"Dance",image:"https://s3-eu-west-1.amazonaws.com/fitnessproject/pole2.jpg",description:"Dance classes at GetFit are not about perfect technique (of lack there of, as the case may be). Dance is more about checking your inhibitions at the door and moving your frame to some great music.
...
c2 = Category.create(name:"Urban",image:"https://s3-eu-west-1.amazonaws.com/fitnessproject/urban.jpg",description:"Want to see incredible results without having to spend your life at the gym?
...
c4 = Category.create(name:"Insanity",image:"https://s3-eu-west-1.amazonaws.com/fitnessproject/insanity.jpg",description:"Forget everything you think you know about high-intensity
